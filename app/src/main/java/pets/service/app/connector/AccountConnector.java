...
public class AccountConnector {
    ...
    public static AccountResponse getAccountById(@NonNull final String id) {
    ...
    public static AccountResponse getAccountsByUser(@NonNull final String username) {
        Map<String, String> headers = Util.getPetsDatabaseAuthHeaders();
    ...
    public static AccountResponse saveNewAccount(@NonNull final AccountRequest accountRequest) {
        Map<String, String> headers = Util.getPetsDatabaseAuthHeaders();
    ...
    public static AccountResponse updateAccount(@NonNull final String id,
    ...
    public static AccountResponse deleteAccount(@NonNull final String id) {
        Map<String, String> headers = Util.getPetsDatabaseAuthHeaders();
