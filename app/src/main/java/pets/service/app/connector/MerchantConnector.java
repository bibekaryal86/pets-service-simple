...
public class MerchantConnector {
    ...
    public static RefMerchantResponse getMerchantById(@NonNull final String id) {
    ...
    public static RefMerchantResponse getMerchantsByUser(@NonNull final String username) {
        Map<String, String> headers = Util.getPetsDatabaseAuthHeaders();
    ...
    public static RefMerchantResponse saveNewMerchant(@NonNull final RefMerchantRequest refMerchantRequest) {
        Map<String, String> headers = Util.getPetsDatabaseAuthHeaders();
    ...
    public static RefMerchantResponse updateMerchant(@NonNull final String id,
    ...
    public static RefMerchantResponse deleteMerchant(@NonNull final String id) {
        Map<String, String> headers = Util.getPetsDatabaseAuthHeaders();
